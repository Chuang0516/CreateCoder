...
@keyframes circle-1 {
    ...
    to {
        stroke-dasharray: 105, 260;
    }
}

#overlap {
    animation: overlap .5s ease-in;
}
...
@keyframes circle-2 {
    ...
    to {
        stroke-dasharray: 62, 290;
    }
}

#circle-3 {
    animation: circle-3 0.3s ease-in;
}
