<template>
    <div class="userInfo">
        <div class="userAvatar">
            <div class="avatar" v-show="currentUser.avatar?.iAvatar" @mouseover="setAvatarbtn = true">
                <img :src="`${currentUser.avatar?.iAvatar}?time=${new Date().getTime()}`" alt="">
            </div>
            <div class="avatar" v-show="currentUser.avatar?.rAvatar" v-html="multiavatar(currentUser.avatar?.rAvatar)"
            ...
            <div class="avatarBox" v-show="avatarBox">
                ...
                <div class="rAvatarBox">
                    ...
                    <div class="handlerBtn refresh" @click="refreshRAvatar"
                        :style="{ '--angle': `${angle}deg`, '--rotateTime': `${rotateTime}ms` }"><i
                    ...
                    <div class="cropperBox">
                        <div class="cropper">
                            <VueCropper ref="cropper" :img="cropperOption.img" :autoCropWidth="cropperOption.autoCropWidth"
                                ...
                                :output-type="cropperOption.outputType" :info="cropperOption.info"
                                :full="cropperOption.full" :can-move="cropperOption.canMove"
                                :can-move-box="cropperOption.canMoveBox" :original="cropperOption.original"
                                :auto-crop="cropperOption.autoCrop" :fixed="cropperOption.fixed"
                                :fixed-number="cropperOption.fixedNumber" :center-box="cropperOption.centerBox"
                                :info-true="cropperOption.infoTrue" :fixed-box="cropperOption.fixedBox"
                                @realTime="realTime" />
                        </div>
                    ...
                    <div class="setIAvatar">
                        <div class="selectIAvatar">
                            <div class="selectRBtn" v-show="!preview.url" @click="toSelectImg($event)">
                                ...
                                <input type="file" ref="fileInput" class="selectInput" @change="getIAvatar($event)" />
                            </div>
        ...
        toSetIAvatar() {
            ...
            if (!avatarBox) {
                ...
                for (let i = 0; i < this.rAvatarNum; i++) {
                    const rId = Math.random().toString(36).slice(- parseInt(Math.random() * 10))
